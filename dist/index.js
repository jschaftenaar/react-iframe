...
var ReactIframe = function (_React$Component) {
  _inherits(ReactIframe, _React$Component);

  function ReactIframe(props) {
    _classCallCheck(this, ReactIframe);

    var _this = _possibleConstructorReturn(this, (ReactIframe.__proto__ || Object.getPrototypeOf(ReactIframe)).call(this, props));

    _this.onPostMessage = _this.onPostMessage.bind(_this);
    _this.postMessage = _this.postMessage.bind(_this);
    _this.onLoad = _this.onLoad.bind(_this);
    _this.origin = _this.origin.bind(_this);
  ...
  _createClass(ReactIframe, [{
    key: 'componentWillReceiveProps',
    value: function componentWillReceiveProps(nextProps) {
      if (JSON.stringify(this.props.message) === JSON.stringify(nextProps.message)) {
        this.postMessage.apply(this, [nextProps.message.procedure].concat(_toConsumableArray(nextProps.message.arguments)));
      }
    }
  }, {
    key: 'origin',
    value: function origin() {
      var url = this.props.src.split('/');
      return url[0] + '//' + url[2];
    }
  }, {
    key: 'onLoad',
    ...
    key: 'postMessage',
    value: function postMessage(procedure) {
...
var messagePropType = _propTypes2.default.shape({
  procedure: _propTypes2.default.string,
  arguments: _propTypes2.default.array
});

ReactIframe.propTypes = {
  allowUpdateHeight: _propTypes2.default.bool,
